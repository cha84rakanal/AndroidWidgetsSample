...
class SimpleWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(loadTitlePref(this@SimpleWidgetConfigureActivity, appWidgetId))
    }

}

private const val PREFS_NAME = "jp.cha84rakanal.androidwidgetssample.SimpleWidget"
